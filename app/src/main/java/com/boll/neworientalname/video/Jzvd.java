...
public abstract class Jzvd extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    public ImageView startButton , ivPlayOrPause , ivPlayOrPauseScreen;
    public SeekBar progressBar , bottomSeekProgress;
    public ImageView fullscreenButton;
    public TextView currentTimeTextView, totalTimeTextView , currentTime , totalTime;
    ...
    public void init(Context context) {
        ...
        ivPlayOrPauseScreen = findViewById(R.id.ivPlayOrPauseScreen);
        ...
        ivPlayOrPauseScreen.setOnClickListener(this);
        progressBar.setOnSeekBarChangeListener(this);
        bottomSeekProgress.setOnSeekBarChangeListener(this);
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.start || i == R.id.ivPlayOrPause || i == R.id.ivPlayOrPauseScreen) {
...
//                        mDownY = y;
    ...
    public void onStateAutoComplete() {
        ...
        bottomSeekProgress.setProgress(100);
        currentTimeTextView.setText(totalTimeTextView.getText());
        currentTime.setText(totalTimeTextView.getText());
    }
...
//        Log.d(TAG, "onProgress: progress=" + progress + " position=" + position + " duration=" + duration);
        ...
        if (position != 0) {
            ...
            currentTime.setText(JZUtils.stringForTime(position));
        }
        totalTimeTextView.setText(JZUtils.stringForTime(duration));
        totalTime.setText(JZUtils.stringForTime(duration));
    }

    public void setBufferProgress(int bufferProgress) {
        if (bufferProgress != 0) {
            progressBar.setSecondaryProgress(bufferProgress);
            bottomSeekProgress.setSecondaryProgress(bufferProgress);
        }
    }
    ...
    public void resetProgressAndTime() {
        ...
        bottomSeekProgress.setSecondaryProgress(0);
        currentTimeTextView.setText(JZUtils.stringForTime(0));
        currentTime.setText(JZUtils.stringForTime(0));
        totalTimeTextView.setText(JZUtils.stringForTime(0));
        totalTime.setText(JZUtils.stringForTime(0));
    }
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        if (fromUser) {
            ...
            currentTime.setText(JZUtils.stringForTime(progress * duration / 100));
        }
    }
    ...
    public void gotoScreenNormal() {//goback本质上是goto
        ...
        ViewGroup mVg = (ViewGroup)getParent();
        if(mVg != null){
            mVg.removeAllViews();
        }
